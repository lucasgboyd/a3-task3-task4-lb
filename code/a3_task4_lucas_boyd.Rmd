...
This document wrangles and visualizes data from the Santa Barbara Long Term Ecological Research Program. This code examines purple urchin sizes at the Naples Reef in 2010 andvisualizes the data in a QQplot. Then, the code compares mean urchin size in the annual treatment versus control groups. 
